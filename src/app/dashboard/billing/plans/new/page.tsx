...
import {
  ArrowLeft, RefreshCw, DollarSign, Zap, Clock,
...
export default function NewPlanPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto pb-10">
        ...
        {/* Page title */}
        <div className="mb-7">
          <h1 className="page-title">Create Membership Plan</h1>
          <p className="text-sm text-slate-500 mt-1">Configure pricing, duration, and access for this membership.</p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    { key: "dailyPrice",   label: "Daily",   hint: "per day",  cycle: "DAILY" },
                    { key: "weeklyPrice",  label: "Weekly",  hint: "per week", cycle: "WEEKLY" },
                    { key: "monthlyPrice", label: "Monthly", hint: "per month",cycle: "MONTHLY" },
                    { key: "yearlyPrice",  label: "Yearly",  hint: "per year", cycle: "YEARLY" },
                  ].map(f => (
                    <div key={f.key}>
                ...
                <p className="text-[11px] text-slate-400 mt-2">Members will be able to choose from the cycles you have priced. At least one price is required.</p>
              </div>

              {/* Recurring: frequency + max payments */}
              {form.planType === "RECURRING" && (
                <div className="form-group">
                  ...
                  <select className="select" value={form.maxPayments}
          ...
          <div className="card p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select className="select" value={form.accessLimit}
              ...
              <div>
                ...
                <select className="select" value={form.capacity}
