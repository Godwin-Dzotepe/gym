...
export default async function ReportsPage() {
  ...
  // Group payments by month (JS — avoids raw SQL table-name issues on Linux MySQL)
  ...
  // Group attendances by day of week (JS)
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card p-5">
          <h2 className="section-title mb-4">Monthly Revenue (Last 6 Months)</h2>
